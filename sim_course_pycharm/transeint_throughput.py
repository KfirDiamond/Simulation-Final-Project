...
def single_sim_rate_arrival_throughtput( mu, sim_time, capacities, num_stations, num_jobs):

    sim_time += 1
    sim_instance = Queue_multi_stations( mu, sim_time, capacities,  num_stations, num_jobs)
    sim_instance.run()
...
class Queue_multi_stations:
    ...
    def __init__(self,  mu, sim_time, capacities, num_stations, num_jobs):
